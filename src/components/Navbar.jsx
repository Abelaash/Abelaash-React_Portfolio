  ...
  return (
    <div className="fixed w-full h-[80px] flex justify-between items-center px-4 bg-[#0a192f] text-gray-300">
      ...
      >
        ...
        <li className="py-6 text-4xl"><Link to="projects" smooth={true} duration={500}>Portfolio</Link></li>
        <li className="py-6 text-4xl"><Link to="education" smooth={true} duration={500}>Education</Link></li>
        <li className="py-6 text-4xl"><Link to="experience" smooth={true} duration={500}>Work</Link></li>
